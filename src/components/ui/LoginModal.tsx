      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 bg-teal-600 text-white text-sm font-medium rounded-lg hover:bg-teal-700 disabled:opacity-50 transition-colors"
          >
        ...
        {mode === "login" && (
          <p className="mt-2 text-center">
            <a href="/auth/forgot-password" className="text-xs text-gray-400 hover:text-gray-600">
